...
def display():
    ...
    for i in range(25):
        if(i<=the_hero.health/the_hero.health_init * 25):
            ...
            print(" ", end="")
    print('|')
    print("For this replay press this number after running the replay python file: ",number_int)
...
replay_number = open("replays/number.txt", "r")
number = replay_number.readlines()
number_int = int(number[0])
number_int = number_int + 1
wrt = open("replays/number.txt", "w")
wrt.write(str(number_int))

replay = open("replays/"+str(number_int)+".txt", "w")
